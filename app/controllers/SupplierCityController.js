'use strict';
app.controller('SupplierCityController', ['$scope', '$routeParams', 'supplierService', 'ngAuthSettings', 'stateService',
        function ($scope, $routeParams, supplierService, ngAuthSettings, stateService) {
          ...
          $scope.filter = [];
          $scope.initialFilter = {name:'CityId', value: $routeParams.cityId};
            ...
            stateService
                ...
                .then(function (response){
                    $scope.city = response
                        .data
                        .find(function (city){ return city.Id == $routeParams.cityId});
                });
