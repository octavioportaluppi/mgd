'use strict';
app.controller(
    'SupplierServiceTypeController',
    [
        '$scope', '$routeParams', 'supplierService', 'ngAuthSettings', 'stateService',
        function ($scope, $routeParams, supplierService, ngAuthSettings, stateService) {
            ...
            $scope.filter = [];
            $scope.initialFilter = {name:'ServiceTypeId', value: $routeParams.serviceId};
            ...
            supplierService
                ...
                .then(function (response){
                    $scope.service = response
                        .data
                        .find(function (service){ return service.Id == $routeParams.serviceId});
                });
